...
//             const response = await axios.post(backendUrl + '/api/order/verifyStripe', { success, orderId }, { headers: { Authorization: `Bearer ${storedToken}`  } });
//             console.log('Response from server:', response.data.success); // Log the response data
...
//     useEffect(() => {
//         verifyPayment();
//     }, [token]); // Verify payment on mount or when token changes
